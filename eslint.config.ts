...
import { ESLINT_ACCEPTANCE_TESTS_HOOKS_FLAT_CONFIG } from "./configs/eslint/flat-configs/eslint-acceptance-tests-hooks.flat-config";
...
export default withNuxt(
  ...
  ESLINT_ACCEPTANCE_TESTS_HOOKS_FLAT_CONFIG,
